...
description: Use to define individual game screen specs with purpose, player actions, information priority, layout, states, interactions, edge cases, data requirements, assets, and implementation notes.
---

# Game Screen Spec Skill
