...
description: Use when implementing UI from screen specs and design-system specs. Produces components, screens, state models, mock data, stories or visual test hooks, and keeps implementation aligned with source specs.
---

# Game UI Implementation Skill
...
9. 구현 중 명세와 충돌한 점은 `Implementation Notes`에 기록한다.
