...
- `game-design/concept-brief.md` (from `game-director`)
...
```text
Use game-concept-designer.

Reference:
  - game-design/concept-brief.md
  - game-design/game-pillars.md

Mood keywords from user: "축축한 지하세계, 희미한 불빛, 잔잔한 공포"

Output:
  - Extend concept-brief.md with worldbuilding
  - Create art-direction.md
  - Create image-prompts.md (for web LLM image generation)
```
