...
- [ ] 같은 rarity 안에서 주요 스탯의 표준편차가 평균의 50%를 넘는가?
- [ ] 가격과 성능의 상관계수가 깨지는가?
...
Task:
  Produce round-1 balance review.
  Output to ai/reviews/balance/round-1.md.
  If outliers found, also produce outliers.md.
```
