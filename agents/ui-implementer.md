---
name: ui-implementer
description: Use after design-system-spec and game-screen-spec are complete. Implements game UI screens and components using the game-ui-implementation skill.
