---
name: ui-planner
description: Use after MVP scope is fixed to define the game UI design system, screen map, screen specs, UI states, and data requirements before implementation.
...
Tasks:
  1. Apply design-system-spec skill
  2. Create ai/specs/ui/screen-map.md
  3. Apply game-screen-spec skill for MVP screens
```
