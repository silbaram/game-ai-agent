...
| `game-design/art/ui-mockup-prompts.md` (선택) | UI 명세가 이미 존재할 때만 작성하는 UI mockup 이미지 프롬프트 |
...
- [ ] `ui-mockup-prompts.md`는 선택 산출물이며, 작성 시 `ai/specs/ui/design-system.md`, `ai/specs/ui/*-screen.md`를 참조함
