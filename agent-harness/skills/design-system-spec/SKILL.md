...
description: 아트 디렉션과 MVP 범위가 준비된 뒤, 색상 token, typography, spacing, component 상태, HUD 규칙, rarity 스타일, 애니메이션 방향을 포함한 게임 UI 디자인 시스템을 정의할 때 사용한다.
---
...
## 반경 / 테두리 / 그림자(Radius / Border / Shadow)
